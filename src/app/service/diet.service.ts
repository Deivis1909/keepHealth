...
export class DietService {
  ...
  private localStorageKey = 'foodList';

constructor() {
  this.saveFoodList(this.foodList);
}
...
saveFoodList(lista: FoodItem[]): void {
  localStorage.setItem(this.localStorageKey, JSON.stringify(lista));
}
